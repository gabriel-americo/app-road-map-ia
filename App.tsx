...
const KEY_GPT = "Sua_API_Key_aqui";
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Text style={styles.heading}>Roteiros Map</Text>
      ...
      <View style={styles.form}>
        ...
        <Slider
          minimumValue={1}
          maximumValue={10}
          minimumTrackTintColor="#02968A"
          maximumTrackTintColor="#020102"
          value={days}
      ...
      >
        ...
        {travel && (
          <View style={styles.content}>
            <Text style={styles.title}>Roteiro da viajem</Text>
            <Text>{travel}</Text>
          </View>
        )}
      </ScrollView>
